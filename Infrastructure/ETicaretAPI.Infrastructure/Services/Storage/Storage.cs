...
namespace ETicaretAPI.Infrastructure.Services.Storage
{
    ...
    {
        protected delegate bool HasFile(string pathOrContainerName, string fileName);//bu delegate üzerinden hangi concrete'te çalışıyorsak oradaki HasFile fonksiyonunu temsil edip aşağıdaki metotta çağırıyor olacağız. bu sayede; ilgili concrete'in kendi storage'ına özel dosya kontrolü yapacak(if (File.Exists ---> kısmı)
